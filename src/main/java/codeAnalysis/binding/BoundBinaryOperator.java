...
public final class BoundBinaryOperator {
    ...
    private static final BoundBinaryOperator[] operators = {
        ...
        new BoundBinaryOperator(SyntaxKind.LessOrEqualsToken, BoundBinaryOperatorKind.LessOrEquals, Integer.class, Boolean.class),

        new BoundBinaryOperator(SyntaxKind.GreaterToken, BoundBinaryOperatorKind.Greater, Integer.class, Boolean.class),
        new BoundBinaryOperator(SyntaxKind.GreaterOrEqualsToken, BoundBinaryOperatorKind.GreaterOrEquals, Integer.class, Boolean.class),
